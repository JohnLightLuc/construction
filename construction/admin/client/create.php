<?php 
  ...
  if(!empty ($_POST)){
    ...
    {
        $array['imageError']  = "Vous n'avez pas charger votre photo !";
      $array['verify'] = false;
    }
    else
    {
    ...
    if($array['verify'] &&  $isUploadSuccess)
    {
        ...
        if($array['password1'] !== $array['password2']) 
        {
            $array['error'] = "Les mots de passe ne sont pas identiques";
                ...
                {
                    if(empty($array['photo'])){
                        $statement = $db->prepare("INSERT INTO `clients`(`nom`, `prenom`, `contact`, `email`, `ville`, `password`) VALUES (?,?,?,?,?,?)");
                        $statement->execute(array($array['nom'], $array['prenom'],$array['contact'],$array['email'], $array['ville'], $array['password1']));
          ...
          <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                ...
                <small class="comments"> <?php echo $array['imageError']; ?></small>
              </div>
            </div>

            <div class="row">
                <div class="col-sm-6">
                    <a href="accueil.php" class="btn btn-warning" value='Annuler'>
                </div>
                <div class="col-sm-6">
